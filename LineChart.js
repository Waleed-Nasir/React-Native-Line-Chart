...
export default class Line extends Component {
  ...
  static defaultProps = {
    fillColor: 'rgba(114, 186, 223,0.3)',       // solid violet color
    fillColorH: 'rgba(244, 67, 54, 0.3)',       // solid violet color
    strokeColor: 'blue',  // semi-transparent violet
    strokeColorH: 'red',  // semi-transparent violet
    strokeWidth: 1,
  };
    ...
    return (
      ...
      >
        <Surface width={width} height={height}>
          <Group x={0} y={height}>
            <Shape
              d={this.buildPath(valuesTem)}
              fill={fillColor}
              stroke={strokeColor}
              strokeWidth={strokeWidth}
            />
            <Shape
              d={this.buildPath(valuesHum)}
              fill={fillColorH}
              stroke={strokeColorH}
              strokeWidth={strokeWidth}
            />
